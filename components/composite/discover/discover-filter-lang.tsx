...
export const DiscoverFilterLang: React.FC<DiscoverFilterLangProps> = ({ value, onChange }) => {
  const selected = languages.find((lang) => lang.iso_639_1 === value)?.english_name;
  ...
  return (
    <div className="space-y-2">
      ...
      <Popover>
        <PopoverTrigger asChild className={cn(value ? "text-foreground" : "text-muted-foreground")}>
      ...
      <CommandList>
        ...
        <CommandGroup>
          <ScrollArea className="max-h-40 overflow-y-auto">
            <LanguageOption value="" selected={!value} onSelect={onSelect}>
              All
            </LanguageOption>
